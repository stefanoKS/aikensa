        ...
        while self.running:
            ...
            if ret:
                ...
                current_widget = stackedWidget.widget(current_widget_index)
                 ...
                 #   frame = process_for_calibration(frame, self.slider_value)
                if current_widget_index == 2:  # edgedetection.ui
                    print(f"Current Widget Index: {current_widget_index}")
                    ...
                    value_opacity = slider_opacity.value()
                    value_blur = slider_blur.value()
                    value_lowercanny = slider_lowercanny.value()
                    value_uppercanny = slider_uppercanny.value()
                    value_contrast = slider_contrast.value()
                    value_brightness = slider_brightness.value()
