...
def partcheck(img, detections, partid=None):
    ...
    if leftmost_detection:
        ...
        edge_left = find_edge_point(img, leftmost_center_pixel, "left", offset_y = endoffset_y)
    ...
    if rightmost_detection:
        ...
        edge_right = find_edge_point(img, rightmost_center_pixel, "right", offset_y = endoffset_y)
    ...
    for detect in detections:
        ...
        if partid == "LH":
            if class_id == 0:
                ...
                center = draw_bounding_box(img, x, y, w, h, [img.shape[1], img.shape[0]], color=(255, 0, 0))
